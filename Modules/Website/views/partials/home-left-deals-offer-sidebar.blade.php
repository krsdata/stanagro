          ...
          <div class="products">
            ...
            <!-- /.hot-deal-wrapper -->
             ...
             <div class="product-info text-left m-t-20">
                ...
                <span class="price-before-discount">₹ {{ $result->price }}</span> 
                </div>
                <!-- /.product-price -->  
              </div>
            <!-- /.product-info -->
                    ...
                    <div class="row product-micro-row">
                      ...
                      <div class="col col-xs-7">
                        <div class="product-info">
                          ...
                          <div class="rating rateit-small"></div>
                          <div class="product-price"> <span class="price"> ₹ {{$deal->price}}</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="row product-micro-row">
                      ...
                      <div class="col col-xs-7">
                        <div class="product-info">
                          <h3 class="name"><a href="{{ url(str_slug($deal->product_title,'-').'/addToCart/'.$deal->id) }}">{{ $deal->product_title}}</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="product-price"> <span class="price"> ₹ {{ $deal->product_title}}</span> </div>
                          <!-- /.product-price --> 
