...
class ProductController extends Controller {
    ...
    public function showLoginForm(Request $request)
    {
      ...
      //  return view('website::login',compact('categories','products','cart'));
        ...
        return view('website::login', compact('categories','products','product_new','banner','all_categories'));
    ...
    {    
        ...
        return view('website::home', compact('categories','products','product_new','banner','all_categories')); 
    }
    ...
    {  
       ...
       // dd($cart);
        ...
        return view('website::checkout',compact('categories','products','cart','product_photo'));  
    }
    ...
    { 
        ...
        return view('website::order',compact('categories','products','cart','billing','shipping'));   
    ...
    public function showSignupForm(Request $request)
    {
        ...
        return view('website::register',compact('categories','products','cart'));
    ...
    {    
        ...
        return view('website::myaccount',compact('transaction','categories','products','cart','billing','shipping'));
     ...
     public function thankYou(Request $request)
    {
      ...
      //   $request->session()->flush();
       // $request->session()->keep(['current_user']); 
        ...
        return view('website::thanku',compact('categories','products','cart','billing','shipping'));
