...
class HomeController extends Controller
{
 ...
 /*----------*/
    public function checkout()
    {
        ...
        $categories = Category::nested()->get(); 
        return view('website::checkout',compact('categories','products'));   
    }
    ...
    { 
        ...
        $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get(); 
        return view('website::order',compact('categories','products','cart'));   
    ...
    public function contact()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get(); 
        return view('website::contact',compact('categories','products')); 
     ...
     public function trackOrder()
    {
         $products = Product::with('category')->orderBy('id','asc')->get();
        $categories = Category::nested()->get(); 
        return view('website::track-orders',compact('categories','products')); 
