...
class AdminController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('packages::dashboard.index', compact('category_count', 'reports_count', 'contact_count', 'page_title', 'page_action', 'viewPage', 'press_count','orders','products','users'));
    }
